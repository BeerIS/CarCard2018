                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-5 col-sm-12">
                                <h4><strong><span class="fa fa-file-text"></span> รายละเอียดบัตร หมายเลข </strong> <?php echo  $card['card_no'] ?></h4>
                            </div>
                        </div>
                        <div class="row" style="margin-top:5px;">
                            <div class="col-lg-5 col-sm-12">
                                <strong>เลขประจำตัว :</strong> <?php echo  $card['owen_id'] ?>
                            </div>
                            <div class="col-lg-7 col-sm-12">
                                <strong>ชื่อ-นามสกุล :</strong> <?php echo  $card['owen'] ?>
                            </div>
                        </div>
                        <div class="row" style="margin-top:5px;">
                            <div class="col-lg-12 col-sm-12">
                                <strong>สังกัด :</strong> <?php echo  $card['owen_add'] ?>
                            </div>
                        </div>
                        <div class="row" style="margin-top:5px;">
                            <div class="col-lg-3 col-sm-12">
                                <strong>โทรศัพท์ :</strong>
                                <input type="text" id="txtTel1" value="<?php echo  $card['tel1'] ?>" />
                            </div>
                            <div class="col-lg-3 col-lg-offset-2 col-sm-12">
                                <strong>มือถือ :</strong>
                                <input type="text" id="txtTel2" value="<?php echo  $card['tel2'] ?>"/>
                            </div>
                            <div class="col-lg-3">
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    while ($cars = mysqli_fetch_array($qCars)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo  $cars['brand_name'] ?></tdphp echo
                        ...
                        <form class="form" method="post" id="frmCar">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12" style="text-align: center">
                                    <?php
                                     //5__ = Print External By CardId: Beer
                                    $fay = "5__".$card['card_id']."__";
                                    $mCrypt = new MCrypt();
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $("#btnSaveTel").click(function(){
                    var f ={"tel1":$("#txtTel1").val(), "tel2":$("#txtTel2").val(),"empId": "<?php echo $card['owen_id'] ?>"};
                    //console.log(f);
                    $.ajax({
                            url: "updatetel_external.php",
                            data: f,
                            type: 'POST',
