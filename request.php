        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-right navbar-top-links">
                    <li style="color: white;"><i class="fa fa-user fa-fw"></i> <? echo $row['name']; ?></li>
                    <li class="dropdown">
                ...
                <div class="navbar-default sidebar" role="navigation" id="slidemenu" name="slidemenu">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            <li>
                                <a href="request.php?menu=car" style="color: black;font-size: 17px;"><i class="fa fa-pencil-square-o fa-fw"></i> ลงทะเบียนขอบัตรอนุญาตจอดรถยนต์</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            switch ($menu) {
                case "car" : $page = "request_car.php";
                    break;
                default : $page = "first.php";
            }
